(function(){
    angular
    .module('andresshop', ['ngMaterial', 'ngResource', 'angular-underscore',  'andresshop.products'])
...
(function(){
  'use strict';
  ProductController.$inject = ['productService', '$mdSidenav', '$mdBottomSheet', '$timeout', '$log'];
  angular
